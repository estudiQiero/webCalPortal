...
const en: typeof ca = {
  ...
  location: {
    ...
    stats: [
      { label: 'Coordinates', value: '41.75408° N, 1.27468° E', href: 'https://www.google.com/maps?q=41.754077,1.274676' },
      { label: 'Elevation', value: '475 m' },
      { label: 'Population (village)', value: '61 (2025)' },
